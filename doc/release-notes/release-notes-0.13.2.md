Palladium Core version 0.13.2 is now available from:

  <https://palladium.org/bin/palladium-core-0.13.2/>
...
- #8908 `4a974b2` Update palladium-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow palladium-tx to create v2 transactions (btcdrak)
