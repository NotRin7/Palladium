...
Palladium Core version 0.19.1 is now available from:

  <https://palladiumcore.org/bin/palladium-core-0.19.1/>
...
From Palladium Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Palladium Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Palladium Core does not yet change appearance when
...
- #17488 fix "palladiumd already running" warnings on macOS (fanquake)
