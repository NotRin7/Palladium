Palladium Core version 0.16.1 is now available from:

  <https://palladiumcore.org/bin/palladium-core-0.16.1/>
...
- #12843 `df38b13` Test starting palladiumd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure palladiumd processes are cleaned up when tests end (sdaftuar)
