Palladium-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/palladium/files/Palladium/palladium-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Palladium
...
New/changed settings (command-line or palladium.conf file)
--------------------------------------------------------
