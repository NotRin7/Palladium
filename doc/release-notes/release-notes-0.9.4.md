Palladium Core version 0.9.4 is now available from:

  https://palladium.org/bin/0.9.4/
...
this update is incompatible with the Palladium system and could lead to consensus
forks.

Palladium Core released binaries from https://palladium.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~palladium/+archive/ubuntu/palladium
- A third-party or self-compiled Palladium Core

upgrade to Palladium Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
