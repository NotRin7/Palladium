Palladium Core version 0.10.4 is now available from:

  <https://palladium.org/bin/palladium-core-0.10.4/>
...
- #6953 `43c2789` Split palladium-tx into its own package
- #6953 `dfe0d4d` Include palladium-tx binary on Debian/Ubuntu
