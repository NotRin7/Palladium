Palladium version 0.5.4 is now available for download at:
http://sourceforge.net/projects/palladium/files/Palladium/palladium-0.5.4/
...
http://gitorious.org/palladium/palladiumd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Palladium-Qt notifications under Growl 1.3.
Increase required age of Palladium-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxPalladium properly when installing Palladium-Qt over it. (Windows)
