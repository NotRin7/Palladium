Palladium Core version 0.9.2.1 is now available from:

  https://palladium.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 PLM to 0.01 PLM
...
- Fix "Start palladium on system login"
