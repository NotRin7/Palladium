Palladium Core version *0.15.2* is now available from:

  <https://palladiumcore.org/bin/palladium-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in palladium-tx (TheBlueMatt)
