Palladium Core version *0.15.0.1* is now available from:

  <https://palladium.org/bin/palladium-core-0.15.0.1/>

and

  <https://palladiumcore.org/bin/palladium-core-0.15.0.1/>
