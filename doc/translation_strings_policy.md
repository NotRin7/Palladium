...
This document provides guidelines for internationalization of the Palladium Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `palladium_en.ts` remains unchanged.
