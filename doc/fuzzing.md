# Fuzzing Palladium Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing Palladium Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
# libFuzzer" on https://github.com/palladium/palladium/blob/master/doc/fuzzing.md#macos-hints-for-libfuzzer
$ make
...
[`process_message`](https://github.com/palladium/palladium/blob/master/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/palladium/palladium/blob/master/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/palladium/palladium/tree/master/src/test/fuzz).
...
The project's collection of seed corpora is found in the [`palladium-core/qa-assets`](https://github.com/palladium-core/qa-assets) repo.

To fuzz `process_message` using the [`palladium-core/qa-assets`](https://github.com/palladium-core/qa-assets) seed corpus:

```sh
$ git clone https://github.com/palladium-core/qa-assets
...
If you find coverage increasing inputs when fuzzing you are highly encouraged to submit them for inclusion in the [`palladium-core/qa-assets`](https://github.com/palladium-core/qa-assets) repo.

Every single pull request submitted against the Palladium Core repo is automatically tested against all inputs in the [`palladium-core/qa-assets`](https://github.com/palladium-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Palladium Core more robust.
...
with certain assembly code from Palladium Core's code. See [developer notes on sanitizers](https://github.com/palladium/palladium/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing Palladium Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing Palladium Core using [`afl-fuzz`](https://github.com/google/afl):
