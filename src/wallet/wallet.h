...
#ifndef PALLADIUM_WALLET_WALLET_H
#define PALLADIUM_WALLET_WALLET_H
...
public:
     ...
     * on this palladium node, and set to 0 for transactions that were created
...
#endif // PALLADIUM_WALLET_WALLET_H
