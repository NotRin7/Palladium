...
#ifndef PALLADIUM_UTIL_MESSAGE_H
#define PALLADIUM_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's palladium address, it must refer to a public key.
...
#endif // PALLADIUM_UTIL_MESSAGE_H
