...
#ifndef PALLADIUM_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define PALLADIUM_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // PALLADIUM_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
