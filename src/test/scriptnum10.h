...
#ifndef PALLADIUM_TEST_SCRIPTNUM10_H
#define PALLADIUM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Palladium Core 0.10.0, for cross-comparison.
 */
public:
