    ...
    mapper(nullptr)
{
    ...
    ui->palladiumAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->palladiumAtStartup);
    ...
    ui->palladiumAtStartup->setToolTip(ui->palladiumAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->palladiumAtStartup->setText(ui->palladiumAtStartup->text().arg(PACKAGE_NAME));

    ui->openPalladiumConfButton->setToolTip(ui->openPalladiumConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new PalladiumUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->palladiumAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openPalladiumConfButton_clicked()
{
