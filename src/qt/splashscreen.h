...
#ifndef PALLADIUM_QT_SPLASHSCREEN_H
#define PALLADIUM_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Palladium Core initialization
...
#endif // PALLADIUM_QT_SPLASHSCREEN_H
