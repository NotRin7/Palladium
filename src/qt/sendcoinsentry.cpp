    ...
    platformStyle(_platformStyle)
{
    ...
    // normal palladium address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying palladium address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &PalladiumAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
