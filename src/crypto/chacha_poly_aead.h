...
#ifndef PALLADIUM_CRYPTO_CHACHA_POLY_AEAD_H
#define PALLADIUM_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@palladium.
 *
 ...
 *
 * The chacha20-poly1305@palladium combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@palladium cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@palladium are relatively fast in
...
#endif // PALLADIUM_CRYPTO_CHACHA_POLY_AEAD_H
