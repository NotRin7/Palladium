# Bootstrappable Palladium Core Builds

This directory contains the files necessary to perform bootstrappable Palladium
Core builds.
...
- 24GB of free disk space on the partition that the Palladium Core git repository
  resides in
...
For a Palladium Core depends development environment, simply invoke
...
From the top of a clean Palladium Core repository:
...
To use dongcarl's substitute server for Palladium Core builds after having
