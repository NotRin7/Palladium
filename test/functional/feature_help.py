...
"""Verify that starting palladium with -h works as expected."""

from test_framework.test_framework import PalladiumTestFramework
from test_framework.util import assert_equal

class HelpTest(PalladiumTestFramework):
    ...
    def run_test(self):
        self.log.info("Start palladium with -h for help text")
        ...
        self.log.info("Start palladium with -version for version information")
        ...
        self.log.info("Start palladiumd with -fakearg to make sure it does not start")
