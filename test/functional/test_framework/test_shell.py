...
class TestShell:
    """Wrapper Class for PalladiumTestFramework.

    The TestShell class extends the PalladiumTestFramework
    ...
    class __TestShell(PalladiumTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by PalladiumTestFramework child class.
            self.num_nodes = 1
