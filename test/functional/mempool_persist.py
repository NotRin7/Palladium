...
By default, palladiumd will dump mempool on shutdown and
...
class MempoolPersistTest(PalladiumTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent palladiumd from writing mempool.dat to disk. Verify that `savemempool` fails")
