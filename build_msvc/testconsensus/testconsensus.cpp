...
// palladium includes.
#include <..\src\script\palladiumconsensus.h>
...
int main()
{
    std::cout << "palladiumconsensus version: " << palladiumconsensus_version() << std::endl;
    ...
    auto op0Result = palladiumconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, palladiumconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
